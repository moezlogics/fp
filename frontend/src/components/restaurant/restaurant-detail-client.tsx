...
function AboutTab({ restaurant, otherBranches }: { restaurant: any; otherBranches: any[] }) {
    ...
    return (
        <div className="bg-white rounded-2xl border border-gray-250 p-4 sm:p-6 shadow-md space-y-6 w-full max-w-full overflow-hidden min-w-0">
            ...
            {/* Owner Description */}
            {r.description && (
                <div className="space-y-2 w-full max-w-full overflow-hidden min-w-0 break-words [word-break:break-word]">
