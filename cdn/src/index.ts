/**
 * Foodies CDN Server — Self-hosted Image Processing & Serving
 *
 * Architecture:
 * ┌────────────────────────────────────────────────────────┐
 * │                    Express Server                      │
...
// Trust proxy for rate-limiter behind reverse proxy (nginx)
app.set("trust proxy", 1);

// ── Body parsers (JSON for non-upload routes) ──
...
// This is the core CDN functionality. Once an image is uploaded,
// it never changes (because the filename includes a timestamp).
// The browser and Flutter app will cache it forever.
app.use(
    "/uploads",
...
app.listen(env.PORT, () => {
    console.log("");
    console.log("╔══════════════════════════════════════════════════╗");
    console.log("║          🖼️  Foodies CDN Server Started          ║");
    console.log("╠══════════════════════════════════════════════════╣");
